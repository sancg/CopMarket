...
const People = ({ name = 'Testimonial' }) => {
  return (
    <section className="my-12 sm:mx-auto sm:max-w-7xl">
      <div className="mx-auto text-center max-w-xl">
        <h3 className="mb-6 text-3xl font-bold text-main-800/80">{name}</h3>
      ...
      <div className="grid gap-6 text-center grid-cols-[repeat(auto-fit,minmax(300px,1fr))]">
